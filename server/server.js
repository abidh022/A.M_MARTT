...
// Define the routes after the MongoDB connection is established
...
// Async function to connect to DB, set up routes, and start the server
async function startServer() {
  try {
    // Wait for MongoDB connection to be established
    await connectToMongo();
    
    // Set up all routes after MongoDB connection
    await setupRoutes();
    ...
    process.exit(1); // Exit the process if there's an issue with MongoDB or routes
  }
}
